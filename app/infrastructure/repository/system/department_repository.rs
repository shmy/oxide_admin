...
use domain::system::port::department_repository::DepartmentRepository;
use domain::system::value_object::department_id::DepartmentId;
use domain::system::{entity::department::Department, error::SystemError};
...
impl DomainRepository for DepartmentRepositoryImpl {
    ...
    async fn by_id(&self, id: &Self::EntityId) -> Result<Self::Entity, Self::Error> {
        ...
        row_opt
            .map(Into::into)
            .ok_or(SystemError::DepartmentNotFound)
    }
